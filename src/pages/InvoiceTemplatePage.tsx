...
const FIELDS: FieldDef[] = [
  ...
  { key: 'requesterRank', label: 'Затребовал: звание / должность', group: 'Заявка' },
  { key: 'requesterName', label: 'Затребовал: ФИО', group: 'Заявка' },
  { key: 'receiverRank', label: 'Получил: звание / должность', group: 'Заявка' },
  { key: 'receiverName', label: 'Получил: ФИО', group: 'Заявка' },
