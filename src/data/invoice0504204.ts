...
export function create0504204Template(): InvoiceTemplate {
  ...
  const elements: InvElement[] = [
    ...
    e({ type: 'text', x: 310, y: 98, w: 300, h: 14, text: '', fontSize: 9, source: '{{senderDept}}' }),
    ...
    e({ type: 'text', x: 495, y: 168, w: 100, h: 14, text: '', fontSize: 9, align: 'center', source: '{{approverRole}}' }),
    ...
    e({ type: 'text', x: 705, y: 168, w: 140, h: 14, text: '', fontSize: 9, align: 'center', source: '{{approverName}}' }),
    ...
    e({ type: 'text', x: 40, y: 462, w: 100, h: 14, text: '', fontSize: 9, align: 'center', source: '{{issuerRank}}' }),
    ...
    e({ type: 'text', x: 260, y: 462, w: 140, h: 14, text: '', fontSize: 9, align: 'center', source: '{{issuerName}}' }),
    ...
    e({ type: 'text', x: 105, y: 530, w: 100, h: 14, text: '', fontSize: 9, align: 'center', source: '{{receiverRank}}' }),
    ...
    e({ type: 'text', x: 325, y: 530, w: 160, h: 14, text: '', fontSize: 9, align: 'center', source: '{{receiverName}}' }),
